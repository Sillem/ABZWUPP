...
print("0 - polish")
print("1 - english")
language = int(input("Which one: "))

### form
print("Choose your form of study: ")
print("0 - full-time studies")
print("1 - part-time studies")
form = int(input("Which one: "))

## study level
print("Choose your study level: ")
print("0 - first cycle (engineering degree)")
print("1 - first cycle (bachelor's degree)")
print("2 - second cycle (post-engineering degree)")
print("3 - second cycle (post-bachelor's degree)")
print("4 - long-cycle")
level = int(input("Which one: "))


if language == 0 and form == 0 and level == 0:
    url = "https://sylabus.sggw.edu.pl/pl/1/19/3/4/40"
elif language == 0 and form == 0 and level == 1: 
    url = "https://sylabus.sggw.edu.pl/pl/1/19/3/2/40"
elif language == 0 and form == 0 and level == 2:
    url =  "https://sylabus.sggw.edu.pl/pl/1/19/3/6/40"
elif language == 0 and form == 0 and level == 3:
    url = "https://sylabus.sggw.edu.pl/pl/1/19/3/3/40"
elif language == 0 and form == 0 and level == 4:
    url = "https://sylabus.sggw.edu.pl/pl/1/19/3/7/40"
elif language == 0 and form == 1 and level == 0:
    url = "https://sylabus.sggw.edu.pl/pl/1/19/4/4/40"
elif language == 0 and form == 1 and level == 1:
    url = "https://sylabus.sggw.edu.pl/pl/1/19/4/2/40"
elif language == 0 and form == 1 and level == 2:
    url = "https://sylabus.sggw.edu.pl/pl/1/19/4/6/40"
elif language == 0 and form == 1 and level == 3:
    url = "https://sylabus.sggw.edu.pl/pl/1/19/4/3/40"
elif language == 1 and form == 0 and level == 0:
    url = "https://sylabus.sggw.edu.pl/pl/1/19/3/4/46"
elif language == 1 and form == 0 and level == 1:
    url = "https://sylabus.sggw.edu.pl/pl/1/19/3/2/46"
elif language == 1 and form == 0 and level == 2:
    url = "https://sylabus.sggw.edu.pl/pl/1/19/3/6/46"
elif language == 1 and form == 0 and level == 3:
    url = "https://sylabus.sggw.edu.pl/pl/1/19/3/3/46"
elif language == 1 and form == 0 and level == 4:
    url = "https://sylabus.sggw.edu.pl/pl/1/19/3/7/46"
else: ValueError("Value error or page does not exist")
...
save_data(subject_names, subject_ids, course_name)
